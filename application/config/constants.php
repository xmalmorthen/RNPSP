...
* Fecha: 30-08-2018
* Descripción: Constante de nombre de variable de sesión
*/
defined('SESSIONVAR') OR define('SESSIONVAR','UserDataSession');

/*
* Autor: Miguel Angel Rueda Aguilar
* Fecha: 30-08-2018
* Descripción: Constantes de cache
*/
defined('DEFAULTTIMEPAGECACHE') OR define('DEFAULTTIMEPAGECACHE', 1800);
defined('DEFAULTTIMEDATACACHE') OR define('DEFAULTTIMEDATACACHE', 1800);
