...
$config['protocol']         = $cnfg->sendMail->protocol;      // 'mail', 'sendmail', or 'smtp'
$config['mailpath']         = '/usr/sbin/sendmail';
$config['smtp_host']        = $cnfg->sendMail->smtp_host;
...
$config['smtp_user']        = $cnfg->sendMail->smtp_user;
$config['smtp_pass']        = $cnfg->sendMail->smtp_pass;
$config['smtp_port']        = $cnfg->sendMail->smtp_port;
$config['smtp_timeout']     = 30;                               // (in seconds)
$config['smtp_crypto']      = $cnfg->sendMail->smtp_type;     // '' or 'tls' or 'ssl'
$config['smtp_debug']       = $cnfg->sendMail->smtp_debug;    // PHPMailer's SMTP debug info level: 0 = off, 1 = commands, 2 = commands and data, 3 = as 2 plus connection status, 4 = low level data output.
...
$config['wrapchars']        = 76;
$config['mailtype']         = $cnfg->sendMail->mailtype;      // 'text' or 'html'
