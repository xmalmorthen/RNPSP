            ...
            <form action="#" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text"  id="pCP_EMP_ADSCRIPCION_ACTUAL" name="pCP_EMP_ADSCRIPCION_ACTUAL" class="form-control" class="form-control" required max="5">
                        </div>
                        <div class="col-md-4">
        ...
        <form action="#">
            ...
            <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <span class="clr">*</span>Código postal
                            <input type="text" id="pCP_EMP_EMPLEOS_DIVERSOS" name="pCP_EMP_EMPLEOS_DIVERSOS" required  class="form-control"  max="5">
                        </div>
                        <div class="col-md-4">
                            <span class="clr">*</span>Estado <!-- Se llena del catalogo "ENTIDAD" -->
                            <select  class="form-control" required>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" id="pSUELDO_EMPLEOS_DIVERSOS" name="pSUELDO_EMPLEOS_DIVERSOS"  class="form-control" max="10">
                        </div>
                        <div class="col-md-4">
                            <span class="clr">*</span>Fecha de ingreso
            ...
            <form action="#" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="pPUESTO_ACTITUDES_EMPLEO" name="pPUESTO_ACTITUDES_EMPLEO" class="form-control" max="150">
                    </div>
                    <div class="col-md-4">
