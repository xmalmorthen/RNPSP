<div class="row mt-4 style="color:#02657C"" id="submenu_datos_generales">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="Datos_personales-tab" data-toggle="tab" href="#Datos_personales" role="tab" aria-controls="Datos_personales" aria-selected="true" style="color:#02657C">Datos personales</a>
        </li>
        <li class="nav-item">
