<div class="row mt-4" >
    <div class="col-md-12">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="Ficha_fotografica-tab" data-toggle="tab" data-callback="objViewIdentificacion.callback.fichaFotografica" href="#Ficha_fotografica" role="tab" aria-controls="Ficha_fotografica" aria-selected="false" style="color:#02657C">Ficha fotográfica</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="Registro_decadactilar-tab" data-toggle="tab" data-callback="objViewIdentificacion.callback.registroDecadactilar" href="#Registro_decadactilar" role="tab" aria-controls="Registro_decadactilar" aria-selected="true" style="color:#02657C">Registro decadactilar</a>
            </li>
            <li class="nav-item">
