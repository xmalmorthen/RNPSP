    ...
    <div class="_container">
        <form action="#" id="Domicilio_form" name="Domicilio_form" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <h6 class="borderButtom">Estado <br><!-- Se  llena del catálogo CAT_ENTIDAD--></h6>
                    <p></p>
                </div>
                <div class="col-md-4">
                    <h6 class="borderButtom">Municipio <br> <!-- Se llena del catálogo CAT_MUNICIPIO --></h6>
                    <p></p>
                </div>
            </div>
            <br>
...
<div class="tab-pane fade" id="Socioeconomicos" role="tabpanel" arialabelledby="Socioeconomicos-tab" >
    <div class="_container">
        <form action="#" id="Socioeconomicos_form" name="Socioeconomicos_form" autocomplete="off">
            ...
            <div class="row">
                <div class="col-md-4">
                    <h6 class="borderButtom">Sexo <br></h6> <!-- Se llena del catálogo CAT_SEXO -->
                    <p></p>
                ...
                <div class="col-md-4">
                    <h6 class="borderButtom">Parentesco</h6> <br><!-- Se llena del catálogo CAT_RELACION -->
                    <p></p>
