            ...
            <div class="tab-pane fade show active" id="Empleos_en_seguridad_publica" role="tabpanel" aria-labelledby="Empleos_en_seguridad_publica-tab">
                <div class="container">
                    <form action="#" autocomplete="off">  
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <span class="clr">*</span>Dependencia
                                        <select name="" id="" class="form-control">
                                            <option value="">Seleccione</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <sppan class="clr">*</sppan>Corporación
                                        <select name="" id="" class="form-control" id="@pINSTITUCION" name="@pINSTITUCION">
                                            <option value="">Seleccione</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <span class="clr">*</span>Puesto funcional
                                        <select name="" id="" class="form-control" id="@pID_PUESTO" name="@pID_PUESTO" required  class="form-control">
                                            <option value="">Seleccione</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        Nivel de mando
                                        <select name="" id="" class="form-control" id="@pID_NIVEL_MANDO" name="@pID_NIVEL_MANDO"></select>
                                    </div>
                                    <div class="col-md-4">
                                        Número de placa
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select name="" id="" class="form-control" id="@pID_ENTIDAD" name="@pID_ENTIDAD" required>
                                            <option value="">Seleccione</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <span class="clr">*</span>Municipio o delegación
                                        <select name="" id="" class="form-control" id="@pID_MUNICIPIO" name="@pID_MUNICIPIO" required>
                                            <option value="">Seleccione</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <span class="clr">*</span>Motivo de separación
                                        <select name="" id="" class="form-control" id="@pID_MOTIVO_MOV_LAB" name="@pID_MOTIVO_MOV_LAB" required><option value="">Seleccione</option></select>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-4">
                                        <span class="clr">*</span>Tipo de separación
                                        <select name="" id="" class="form-control" id="@ID_TIPO_MOV_LAB" name="@ID_TIPO_MOV_LAB" required>
                                            <option value="">Seleccione</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        Tipo de baja
                                        <select name="" id="" class="form-control" id="@pID_TIPO_BAJA" name="@pID_TIPO_BAJA">
                                            <option value="">Seleccione</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select name="" id="" class="form-control" id="@pID_FUNCION_PUESTO" name="@pID_FUNCION_PUESTO"></select>
                                    </div>
                                </div>
                                <br>
                                <br>
                ...
                <div class="container">
                    <form action="#" autocomplete="off">  
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <span class="clr">*</span>Colonia
                                    <select name="@pCOLONIA_EMP" id="@pCOLONIA_EMP" class="form-control" required><option value="">Seleccione</option></select>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <span class="clr">*</span>Motivo de separación
                                    <select name="" id="" class="form-control" id="@pID_MOTIVO_MOV_LAB" name="@pID_MOTIVO_MOV_LAB" required >
                                        <option value="">Seleccione</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                ...
                <div class="container">
                    <form action="#" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <span class="clr">*</span>Corporación
                                    <select name="" id="" class="form-control" id="@pINSTITUCION" name="@pINSTITUCION" required>
                                        <option value="">Seleccione</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    Área
                                <select name="" id="" class="form-control" id="@pID_AREA" name="@pID_AREA"></select>
                                </div>
                                <div class="col-md-4">
                                    División
                                    <input type="text" id="@pDIVISION" name="@pDIVISION"  class="form-control">
                ...
                <div class="container">
                    <form action="#" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ¿Conoce el reglamento de los reconocimientos?
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select name="" id="" class="form-control" id="@pCONOCE_REG_ASCENSO" name="@pCONOCE_REG_ASCENSO">
                                    <option value="">Seleccione</option>
                                </select>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="tab-pane fade" id="Disciplina_policial" role="tabpanel" aria-labelledby="Disciplina_policial-tab">
                <div class="container">
                    <form action="#" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <span class="clr">*</span>Tipo disciplina
                                <select name="" id="" class="form-control" id="@pID_TIPO_DISCIPLINA" name="@pID_TIPO_DISCIPLINA" required><option value="">Seleccione</option></select>
                            </div>
                            <div class="col-md-4">
                                <span class="clr">*</span>Subtipo disciplina
                                <select name="" id="" class="form-control" id="@pID_SUBTIPO_DIS" name="@pID_SUBTIPO_DIS" required><option value="">Seleccione</option></select>
                            </div>
                            <div class="col-md-4">
                    ...
                    <form action="#" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="date" name="" id="" id="@pFECHA_INICIO" name="@pFECHA_INICIO" required class="form-control">
                            </div>
                            <div class="col-md-4">
                                <span class="clr">*</span>Fecha de término
                                <input type="date" name="" id="" id="@pFECHA_TERMINO" class="form-control">
                            </div>
                            <div class="col-md-4">
                                <span class="clr">*</span>Tipo
                                <select name="" id="" class="form-control" id="@ID_TIPO_COMISION" name="@ID_TIPO_COMISION" required><option value="">Seleccione</option></select>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-4">
                                <span class="clr">*</span>Motivo
                                <select name="" id="" class="form-control" id="@pID_MOTIVO" name="@pID_MOTIVO" required><option value="">Seleccione</option></select>
                            </div>
                            <div class="col-md-4">
