                            ...
                            <table class="table">
                                <tbody>
                                    <tr class="info">
                                        ...
                                        <td class="font-red-mint"> <?php echo site_url('/'.$metodo['Modulo'].'/'.$metodo['Controlador'].'/'.$metodo['Metodo']); ?> </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="info">
                                        <td class="text-right"> Metodo de envio: </td>
                                        <td class="font-red-mint" > <?php echo $metodo['MetodoEnvio']; ?> </td>
                                    </tr>
                                    
                                    <tr class="info">
                                        <td class="text-right"> Metodo de webservice: </td>
                                        <td class="font-red-mint"> <?php echo $metodo['TipoWebService']; ?> </td>
                                    </tr>
                                    <tr>
                                        <td class="text-right"> Paramentros Entrada: </td>
                                        <td> <?php echo $metodo['ParametrosEntrada']; ?> </td>
                                    </tr>
                                    <tr>
                                        <td class="text-right"> Usuarios con acceso: </td>
                                        <td> <?php 
