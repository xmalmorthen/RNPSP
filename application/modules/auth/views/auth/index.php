...
<html lang="en">
    <head>
        ...
        $this->carabiner->display('jquery-migrate');
        
        $this->carabiner->display('underscorejs');
        $this->carabiner->display('backbonejs');
        
        $this->carabiner->display('toastr','css');
        ?>
        
        <?php $this->carabiner->display('templateInicio','css');?>
        <?php $this->carabiner->display('utils','css');?>
        <?php $this->carabiner->display('mensaje','css');?>
    ...
    <body>
        ...
        <div class="login-form">
            ...
            <form action="<?php site_url('home'); ?>" method="post">
                ...
                <div class="form-group">
                        <input type="text" class="form-control" name="identity" placeholder="Usuario" required="required">
                </div>
                        <div class="form-group">
                    <input type="password" class="form-control" name="password" placeholder="Contraseña" required="required">
                </div>        
                <div class="form-group">
                    <button id="ingresar" type="button" class="btn btn-success btn-lg btn-block">Entrar</button>
                </div>
        ...
        <?php 
        $this->carabiner->display('templateInicio','js');
//        NOTIFICACIONES
        $this->carabiner->display('toastr','js');
        ?>
        
        <?php $this->carabiner->display('utils','js');?>
        <?php $this->carabiner->display('mensaje','js');?>
